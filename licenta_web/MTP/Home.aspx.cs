...
namespace MTP
{
    public partial class Home : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //            htmlTable += " < tr > < td >${ email}</ td >  < td >${ Nume}</ td > < td >${ Prenume}</ td > < td >${ Gen}</ td >< td >${ Adresa}</ td > < td >${ Judet}</ td >< td >${ CNP}</ td >< td >${ SerieCI}</ td > < td >${ NrCI}</ td >< td >${ NumeMama}</ td > < td >${ NumeTata}</ td >< td >${ Facultatea}</ td > < td >${ NrMatricol}</ td >< td >${ AnStudiu}</ td > < td >${ Specializarea}</ td >< td >${ TeleofonParinte}</ td >< td >${ TelefonStudent}</ td > </ tr >";
